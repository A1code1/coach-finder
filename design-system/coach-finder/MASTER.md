...
- **Note:** locked to Poppins/Open Sans (not the Barlow pairing this query's auto-match returned) to match the "Trusted Marketplace" option the user selected, which paired this exact palette with Poppins/Open Sans.
